...
local mainTab = mainWindow:Tab("Main", "rbxassetid://11436779516")

local mainSection = mainTab:Section("功能面板")
...
mainSection:Button("IYFE", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source'))()
end)

mainSection:Button("美化器",function()
